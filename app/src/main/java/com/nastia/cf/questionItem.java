...
public class questionItem extends Item {
    ...
    public static questionItem create(String title, String description) {
        return new questionItem(title, description);
    }

    questionItem(String title, String description) {
        mTitle = title;
